...
class EmailOrderController
{
    ...
    public function cancel(Request $request, Response $response, array $args): Response
    {
        try {
            ...
            if (!in_array($order->getStatus(), [EmailOrderStatus::PENDING_APPROVAL, EmailOrderStatus::PENDING, EmailOrderStatus::PROCESSING])) {
                $response->getBody()->write(json_encode([
                    'success' => false,
    ...
    public function delete(Request $request, Response $response, array $args): Response
    {
        try {
            ...
            if (in_array($order->getStatus(), [EmailOrderStatus::PROCESSING, EmailOrderStatus::PENDING])) {
                $response->getBody()->write(json_encode([
                    'success' => false,
